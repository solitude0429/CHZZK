...
- [ ] Redirect behavior stays scoped to trusted CHZZK HLS requests within the documented live and mini-player boundaries.
...
- [ ] Affected documentation matches the final code and actual verification/deployment results; historical snapshots remain dated and unresolved failures remain explicit.
