...
- Neutralizes recognized decrypted live, event-live, and VOD GFP schedules plus live/VOD NAVER waterfall responses in the page MAIN world while preserving their response envelopes and tracking context. Every schedule break must match its schedule family and contain populated record-only sources; malformed, crossed, mixed, unobserved, and unrelated payloads fail open.
- Suppresses only CHZZK's known ad-blocking/ad UI overlays and exact live/VOD response banners while leaving unrelated banners rendered.
