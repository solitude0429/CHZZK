...
- The final exact-head diff is reviewed directly by the operating Codex task. High-risk release, permission, deployment, and security-policy impact is called out in the PR body. The sole-owner branch does not require an impossible self-approval or a duplicate bot-review check; it does require GitHub-Actions-bound CI, Firefox E2E, dependency review, CodeQL, administrator enforcement, and zero unresolved conversations.
