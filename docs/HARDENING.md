...
- Release/security review gating combines sensitive paths with explicit labels and requires authoritative automated-review completion on the exact PR head plus zero unresolved actionable threads. Missing completion state is failure, never inferred success.
